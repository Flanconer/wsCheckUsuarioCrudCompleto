    ...
    <table width="70%" border="0">
        <tr>
            ...
            <td width="70%">
                ...
                <asp:ImageButton ID="ImageButton5" runat="server" DescriptionUrl="~/imagenes/icon_logalum.GIF" ImageUrl="~/imagenes/icon_logalum.GIF" OnClick="ImageButton5_Click" Width="18px" />
        ...
        <tr>
            ...
            <td width="70%">
                ...
                <asp:TextBox ID="TextBox5" runat="server" MaxLength="8" Width="148px" Height="30px"></asp:TextBox>
        ...
        <tr>
            ...
            <td width="70%" class="auto-style1">
                ...
                <asp:TextBox ID="TextBox6" runat="server" MaxLength="8" Width="148px" Height="16px"></asp:TextBox>
        ...
        <tr>
            ...
            <td width="70%">
                ...
                <asp:TextBox ID="TextBox7" runat="server" MaxLength="35" Width="152px" Height="16px"></asp:TextBox>
        ...
        <tr>
            ...
            <td width="70%">
                ...
                <asp:DropDownList ID="DropDownList1" runat="server" Height="16px" Width="312px">
                </asp:DropDownList>
